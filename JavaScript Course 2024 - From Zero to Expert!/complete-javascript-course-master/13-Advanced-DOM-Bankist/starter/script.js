...
const openModal = function () {
  e.preventDefault(); // fixing the jumping page by clicking a link
...
const loadImg = function (entries, observer) {
  ...
  observer.unobserve(entry.taarget);
};
...
const header = document.querySelector(`.header`);
const allSeciont = document.querySelectorAll(`.section`);
console.log(allSeciont);
...
console.log(message.style.heigh);
